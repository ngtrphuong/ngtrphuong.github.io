...
description: "Replace a slow, ad-heavy comment system with GitHub Discussions — zero backend, zero cost. Teaches: giscus setup, GitHub Apps, data ownership."
icon: "fas fa-comments"
tags: [giscus, disqus, comments, jekyll, github-pages, github]
related:
  - 2023-04-09-captura-unmaintained
  - 2026-03-09-luddites-vs-developers
  - 2026-03-12-ai-blog-generation-flow
---
import giscusHero from '@images/giscus-hero.svg';
...
<Picture src={giscusHero} alt="Before and after comparison: Disqus with ad banners, tracking scripts and slow loading on the left; clean giscus GitHub Discussions widget on the right" />
...
- Your repository name (e.g. `ngtrphuong/ngtrphuong.github.io`)
...
<script src="https://giscus.app/client.js"
        data-repo="ngtrphuong/ngtrphuong.github.io"
        data-repo-id="R_kgDOTbBprg"
        data-category-id="DIC_kwDOTbBprs4DBXss"
...
*If you want to streamline the rest of your Jekyll workflow too, check out <PostLink slug="2026-03-12-ai-blog-generation-flow" /> — it's the other half of keeping this blog low-friction.*
