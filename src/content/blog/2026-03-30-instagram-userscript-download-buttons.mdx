...
description: "All three Instagram techniques bundled into one persistent userscript that injects a ⬇ button directly into the Instagram UI. Teaches: Tampermonkey/Greasemonkey userscripts, @grant directives, persistent DOM injection."
icon: "fab fa-instagram"
accent_color: "#C13584"
tags: [instagram, hack, javascript, browser, userscript, social-media]
related:
  - 2026-03-22-instagram-story-sniper
  - 2026-03-21-instagram-reel-sniper
  - 2026-03-21-save-instagram-photos
  - 2026-03-22-reddit-video-sniper
  - 2026-03-21-youtube-shorts-sniper
  - 2026-03-21-twitter-x-video-sniper
---

*The three earlier Instagram posts — <PostLink slug="2026-03-21-save-instagram-photos" />, <PostLink slug="2026-03-21-instagram-reel-sniper" />, and <PostLink slug="2026-03-22-instagram-story-sniper" /> — each require you to open the browser console, paste a snippet, and press Enter every single time you want to save something. This post bundles all three techniques into one persistent userscript that injects a **⬇ button** directly into the Instagram UI — no console, no paste, no repeat setup.*
...
// @namespace    https://ngtrphuong.github.io/
// @version      1.0
...
Every DOM element rendered by React has a hidden property whose name starts with `__reactFiber$` or `__reactProps$` (followed by a random suffix that changes with each React build). This property holds the component's internal state — including the CDN URLs Instagram retrieved from its servers. The scraper walks up the DOM from the target element, finds these hidden properties, and crawls their object trees looking for `.mp4`, `.jpg`, or `.webp` URLs. This approach is shared by both the photo handler and the story handler; it comes directly from the <PostLink slug="2026-03-22-instagram-story-sniper" />.
...
*For the individual console-based versions of each technique, see <PostLink slug="2026-03-21-save-instagram-photos" />, <PostLink slug="2026-03-21-instagram-reel-sniper" />, and <PostLink slug="2026-03-22-instagram-story-sniper" />. You can also <PostLink slug="2026-03-22-reddit-video-sniper" /> and <PostLink slug="2026-03-21-youtube-shorts-sniper" /> with the same browser-only approach.*
