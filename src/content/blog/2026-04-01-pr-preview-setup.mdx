...
description: "Get a live preview URL for every pull request so you can review posts exactly as readers will see them. Teaches: GitHub Actions, GitHub Pages environments, PR automation."
...
related:
  ...
  - 2026-03-12-ditching-disqus-for-giscus
---
...
```
https://ngtrphuong.github.io/pr-preview/pr-{NUMBER}/
```
...
- name: Deploy PR preview
  ...
  with:
    ...
    pages-base-url: ngtrphuong.github.io
```
