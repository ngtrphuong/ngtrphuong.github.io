...
description: "Track scroll depth, code copies, TOC clicks, social shares, and more — without any paid analytics tool. Teaches: GA4 custom events, IntersectionObserver, passive scroll listeners, debounced selectionchange."
...
related:
  ...
  - 2026-04-02-adsense-auto-vs-custom-placement
---
...
The full implementation is in [`scripts/formatting.js`](https://github.com/ngtrphuong/ngtrphuong.github.io/blob/main/scripts/formatting.js) and [`scripts/search.js`](https://github.com/ngtrphuong/ngtrphuong.github.io/blob/main/scripts/search.js). Every technique described in this post is live on the page you are reading right now.

---

*This post was generated with the assistance of AI as part of an <PostLink slug="2026-03-12-ai-blog-generation-flow" />. The research, curation, and editorial choices were made by an AI agent; any errors are its own.*
